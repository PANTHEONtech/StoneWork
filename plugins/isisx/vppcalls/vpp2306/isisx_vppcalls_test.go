...
import (
	...
	"go.pantheon.tech/stonework/plugins/binapi/vpp2306/isisx"
	"go.pantheon.tech/stonework/plugins/isisx/vppcalls"
	"go.pantheon.tech/stonework/plugins/isisx/vppcalls/vpp2306"
)
...
func isisxTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.ISISXVppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	isisxHandler := vpp2306.NewISISXVppHandler(ctx.MockChannel, ifIdx, log)
