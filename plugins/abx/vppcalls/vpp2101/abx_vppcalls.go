...
import (
	...
	"go.pantheon.tech/stonework/plugins/binapi/vpp2101/abx"
)
...
// AbfAttachInterface attaches interface to the ABF
...
// AbfDetachInterface detaches interface from the ABF
