...
import (
	...
	natba "go.pantheon.tech/stonework/plugins/binapi/vpp2202/nat64"
	"go.pantheon.tech/stonework/plugins/binapi/vpp2202/nat_types"

	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/vppmock"

	"go.pantheon.tech/stonework/plugins/nat64/vppcalls"
	"go.pantheon.tech/stonework/plugins/nat64/vppcalls/vpp2202"
...
func natTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.Nat64VppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	natHandler := vpp2202.NewNat64VppHandler(ctx.MockChannel, swIfIndexes, log)
