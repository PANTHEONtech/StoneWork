...
import (
	...
	"go.pantheon.tech/stonework/plugins/binapi/vpp2101/ip_types"
	natba "go.pantheon.tech/stonework/plugins/binapi/vpp2101/nat64"
	"go.pantheon.tech/stonework/plugins/binapi/vpp2101/nat_types"
	vpp_vpe "go.pantheon.tech/stonework/plugins/binapi/vpp2101/vpe"

	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/vppmock"

	"go.pantheon.tech/stonework/plugins/nat64/vppcalls"
	"go.pantheon.tech/stonework/plugins/nat64/vppcalls/vpp2101"
...
func natTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.Nat64VppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	natHandler := vpp2101.NewNat64VppHandler(ctx.MockChannel, swIfIndexes, log)
