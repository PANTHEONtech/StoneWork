...
import (
	...
	"go.pantheon.tech/stonework/plugins/binapi/vpp2306/ip_types"
	"go.pantheon.tech/stonework/plugins/binapi/vpp2306/memclnt"
	natba "go.pantheon.tech/stonework/plugins/binapi/vpp2306/nat64"
	"go.pantheon.tech/stonework/plugins/binapi/vpp2306/nat_types"

	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/vppmock"

	"go.pantheon.tech/stonework/plugins/nat64/vppcalls"
	"go.pantheon.tech/stonework/plugins/nat64/vppcalls/vpp2306"
...
func natTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.Nat64VppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	natHandler := vpp2306.NewNat64VppHandler(ctx.MockChannel, swIfIndexes, log)
