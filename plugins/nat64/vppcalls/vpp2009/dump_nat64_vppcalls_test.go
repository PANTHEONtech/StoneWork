...
import (
	...
	"go.pantheon.tech/stonework/plugins/binapi/vpp2009/ip_types"
	natba "go.pantheon.tech/stonework/plugins/binapi/vpp2009/nat"
	"go.pantheon.tech/stonework/plugins/binapi/vpp2009/nat_types"
	vpp_vpe "go.pantheon.tech/stonework/plugins/binapi/vpp2009/vpe"

	"go.ligato.io/vpp-agent/v3/plugins/vpp/ifplugin/ifaceidx"
	"go.ligato.io/vpp-agent/v3/plugins/vpp/vppmock"

	"go.pantheon.tech/stonework/plugins/nat64/vppcalls"
	"go.pantheon.tech/stonework/plugins/nat64/vppcalls/vpp2009"
...
func natTestSetup(t *testing.T) (*vppmock.TestCtx, vppcalls.Nat64VppAPI, ifaceidx.IfaceMetadataIndexRW) {
	...
	natHandler := vpp2009.NewNat64VppHandler(ctx.MockChannel, swIfIndexes, log)
