...
| remote_ip | [string](#string) |  | Remote IP address |
| local_spi | [uint32](#uint32) |  | Local security parameter index |
| remote_spi | [uint32](#uint32) |  | Remote security parameter index |
| crypto_alg | [ligato.vpp.ipsec.CryptoAlg](#ligato.vpp.ipsec.CryptoAlg) |  | Cryptographic algorithm for encryption |
| local_crypto_key | [string](#string) |  |  |
| remote_crypto_key | [string](#string) |  |  |
| integ_alg | [ligato.vpp.ipsec.IntegAlg](#ligato.vpp.ipsec.IntegAlg) |  | Cryptographic algorithm for authentication |
| local_integ_key | [string](#string) |  |  |
| remote_integ_key | [string](#string) |  |  |
| enable_udp_encap | [bool](#bool) |  |  |
